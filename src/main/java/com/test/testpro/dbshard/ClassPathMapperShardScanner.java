 ...
 * @version $Id$
 */
public class ClassPathMapperShardScanner extends ClassPathBeanDefinitionScanner {
  ...
  public ClassPathMapperShardScanner(BeanDefinitionRegistry registry) {
  ...
  public void setSqlSessionShardTemplate(SqlSessionShardTemplate sqlSessionTemplate) {
