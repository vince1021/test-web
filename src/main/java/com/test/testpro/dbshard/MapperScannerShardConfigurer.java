 ...
 * @version $Id$
 */
public class MapperScannerShardConfigurer implements BeanDefinitionRegistryPostProcessor, InitializingBean, ApplicationContextAware, BeanNameAware {
  ...
  private SqlSessionShardTemplate sqlSessionTemplate;
   ...
   */
  @Deprecated
  public void setSqlSessionTemplate(SqlSessionShardTemplate sqlSessionTemplate) {
  ...
  public void setSqlSessionFactory(SqlSessionFactory sqlSessionFactory) {
    ...
    this.sqlSessionTemplate = new SqlSessionShardTemplate(sqlSessionFactory);
  }
  ...
  public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) {
    ...
    ClassPathMapperShardScanner scanner = new ClassPathMapperShardScanner(registry);
    scanner.setAddToConfig(this.addToConfig);
    scanner.setAnnotationClass(this.annotationClass);
    scanner.setMarkerInterface(this.markerInterface);
    scanner.setSqlSessionFactory(this.sqlSessionFactory);
    scanner.setSqlSessionShardTemplate(this.sqlSessionTemplate);
